              ...
              <div>
                ...
                {canResetPassword && (
                  <Link
                    ...
                    className="rounded-md text-sm text-violet-ultra underline duration-300 hover:text-black-bean focus:outline-0 focus:ring-2 focus:ring-violet-ultra focus:ring-offset-2"
                  >
